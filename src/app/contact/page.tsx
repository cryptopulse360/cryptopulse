    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4" data-testid="faq-section">Frequently Asked Questions</h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-medium mb-2" data-testid="sponsored-question">Do you accept sponsored content or advertisements?</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div>
            <h3 className="text-lg font-medium mb-2" data-testid="correction-question">How do I report an error or request a correction?</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div>
              <h3 className="text-lg font-medium mb-2" data-testid="syndicate-question">Can I republish or syndicate CryptoPulse content?</h3>
              <p className="text-gray-600 dark:text-gray-400">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4" data-testid="response-times">Response Times</h2>
        ...
        <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg mt-8">
          <h3 className="text-lg font-semibold mb-2" data-testid="stay-connected">Stay Connected</h3>
